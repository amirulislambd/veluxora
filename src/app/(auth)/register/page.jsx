      ...
      <div className="flex gap-10 bg-[#0A0A0F]/80 border border-[#C9A84C]/20  p-5 md:p-10 rounded-md shadow-[0_0_16px_rgba(201,168,76,0.25)]">
        ...
        <div className="w-full max-w-[380px]">
          ...
          >
            ...
            {/* Photo — Radio Toggle + Conditional Field */}
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-md text-[11px] font-semibold tracking-[0.1em] border transition-all duration-200 relative w-full cursor-pointer flex items-center justify-center gap-2.5 border border-white/30 rounded-full py-2.5 text-[11px] font-medium tracking-wide text-white/60 overflow-hidden hover:border-yellow-600/30 hover:bg-white/[0.03] transition-all before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full
                  ...
                  >
                    ...
                    >
                      {photoMode === opt.value && (
                        <span className="w-1.5 h-1.5 rounded-full bg-[#e6c364] block" />
                      )}
                    </span>
                    {opt.label}
                  </button>
              ...
              {photoMode === "file" && (
                <label className="relative flex items-center gap-3 bg-white/[0.04] border border-yellow-600/20 rounded-md px-4 py-2.5 cursor-pointer hover:border-yellow-500/60 hover:bg-white/[0.07] transition-all duration-200 group">
                  ...
                  <span
                    className="text-white/25 text-sm truncate"
                    id="file-label"
                  >
                    Choose a file...
                  </span>
            ...
            <div className="flex items-center gap-3 ">
              ...
              <span className="text-[11px] text-white tracking-widest ">
                OR
              </span>
              <div className="flex-1 h-px bg-white/10" />
            </div>
