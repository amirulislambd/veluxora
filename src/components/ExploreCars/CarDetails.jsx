    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white font-sans">
      ...
      <div className="relative w-full h-[240px] bg-[#111] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1523275335684-37898b6c0776?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80')",
          }}
        />
