...
export default function ExploreFilterBar() {
  ...
  return (
    ...
    >
      <div className="px-4 sm:px-6 md:px-8 py-3 sm:py-[18px]">
        {/* Mobile Layout */}
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-3 flex-wrap">
              <FilterDropdown
                ...
                onChange={handleType}
              />
              <div className="w-px h-6 bg-[#4d4637]/60 flex-shrink-0" />
              <FilterDropdown
                label="Status"
                value={availability}
            ...
            <button
              ...
              className={`w-9 h-9 rounded-[10px] border flex-shrink-0 flex items-center justify-center cursor-pointer transition-all duration-200
                ${
                  isGrid
