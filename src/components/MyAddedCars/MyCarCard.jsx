    ...
    <div className="bg-[#12121A] border border-[#e6c364]/10 rounded-sm overflow-hidden hover:border-[#e6c364]/25 transition-all duration-300 group">
      ...
      <div className="relative aspect-[16/9] overflow-hidden">
        ...
        <div className="absolute top-3 right-3">
          <span className={`text-[9px] tracking-[0.2em] uppercase px-2.5 py-1 rounded-full border backdrop-blur-sm
            ${availability_status
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2 py-3 border-t border-b border-[#e6c364]/8">
          <div className="text-center">
            <p className="text-[9px] tracking-widest uppercase text-[#6B6B7A] mb-1">Monthly</p>
            <p className="text-sm font-semibold text-[#e6c364]">
              ${daily_rent_price}
            </p>
          </div>
          <div className="text-center border-x border-[#e6c364]/8">
            <p className="text-[9px] tracking-widest uppercase text-[#6B6B7A] mb-1">Bookings</p>
            <p className="text-sm font-semibold text-white">{booking_count || 0}</p>
          </div>
          <div className="text-center">
            <p className="text-[9px] tracking-widest uppercase text-[#6B6B7A] mb-1">Seats</p>
            <p className="text-sm font-semibold text-white">{seat_capacity} m</p>
          </div>
        </div>
